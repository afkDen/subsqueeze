...
import { Info, UserPlus, CheckCircle2, Calendar, Wallet } from 'lucide-react'
      ...
      <div className="col-span-1 md:col-span-6 lg:col-span-5 flex items-center justify-center p-8 sm:p-12 bg-card relative">
        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="space-y-2">
            <h3 className="text-2xl sm:text-3xl font-heading font-bold text-foreground">Create Account</h3>
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              />
              <p className="text-[10px] text-muted-foreground font-sans px-0.5">
